        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">取消预约</h4>
                </div>
                <div class="modal-body">
                    <!-- form开始 -->
                    <form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                        <button onclick="showCancelConfirmation()" type="button" class="btn btn-primary">确认</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function showCancelConfirmation() {
            swal({
                ...
                if (isConfirm) {
                    // 在这里执行取消预约的逻辑，比如调用原来的 upd 函数或者发送 ajax 请求等
                    upd();
                    swal({
                        title: "已取消",
                        text: "该课程预约已成功取消",
                        type: "success",
                        timer: 100, // 设置 2 秒后自动关闭弹窗
